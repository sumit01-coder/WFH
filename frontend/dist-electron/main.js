...
import { BrowserWindow as t, Menu as n, Notification as r, Tray as i, app as a, globalShortcut as o, ipcMain as s, powerMonitor as c } from "electron";
...
var d = Object.create, f = Object.defineProperty, p = Object.getOwnPropertyDescriptor, m = Object.getOwnPropertyNames, h = Object.getPrototypeOf, g = Object.prototype.hasOwnProperty, _ = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), v = (e, t, n, r) => {
	...
	return e;
}, y = (e, t, n) => (n = e == null ? {} : d(h(e)), v(t || !e || !e.__esModule || !g.call(e, "default") ? f(n, "default", {
	value: e,
	enumerable: !0
}) : n, e)), b = /* @__PURE__ */ e(import.meta.url), x = /* @__PURE__ */ _(((e) => {
	...
	var n = b("constants"), r = process.cwd, i = null, a = process.env.GRACEFUL_FS_PLATFORM || process.platform;
	...
	var n = b("fs"), r = S(), i = C(), a = w(), o = b("util"), s, c;
	...
	o.debuglog ? d = o.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (d = function() {
		...
		d(n[s]), b("assert").equal(n[s].length, 0);
	...
	var n = E(), { checkPath: r } = D(), i = (e) => typeof e == "number" ? e : {
		mode: 511,
		...e
	}.mode;
	...
	var n = x().fromPromise, { makeDir: r, makeDirSync: i } = O(), a = n(r);
	t.exports = {
		mkdirs: a,
		mkdirsSync: i,
		mkdirp: a,
	...
	var n = T(), r = b("path"), i = k().mkdirs, a = A().pathExists, o = j().utimesMillis, s = M();
	function c(e, t, n, r) {
	...
	function f(e, t, r, i, a) {
		(i.dereference ? n.stat : n.lstat)(t, (n, o) => n ? a(n) : o.isDirectory() ? C(o, e, t, r, i, a) : o.isFile() || o.isCharacterDevice() || o.isBlockDevice() ? p(o, e, t, r, i, a) : o.isSymbolicLink() ? N(e, t, r, i, a) : o.isSocket() ? a(/* @__PURE__ */ Error(`Cannot copy a socket file: ${t}`)) : o.isFIFO() ? a(/* @__PURE__ */ Error(`Cannot copy a FIFO pipe: ${t}`)) : a(/* @__PURE__ */ Error(`Unknown file: ${t}`)));
	}
	...
	function h(e, t, r, i, a) {
		n.copyFile(t, r, (n) => n ? a(n) : i.preserveTimestamps ? g(e.mode, t, r, a) : x(r, e.mode, a));
	}
	function g(e, t, n, r) {
	...
	function C(e, t, n, r, i, a) {
		return t ? E(n, r, i, a) : w(e.mode, n, r, i, a);
	}
	function w(e, t, r, i, a) {
		n.mkdir(r, (n) => {
			if (n) return a(n);
			E(t, r, i, (t) => t ? a(t) : x(r, e, a));
		});
	}
	function E(e, t, r, i) {
		n.readdir(e, (n, a) => n ? i(n) : D(a, e, t, r, i));
	}
	function D(e, t, n, r, i) {
		let a = e.pop();
		return a ? O(e, a, t, n, r, i) : i();
	}
	...
	var n = T(), r = b("path"), i = k().mkdirsSync, a = j().utimesMillisSync, o = M();
	function s(e, t, n) {
	...
	function u(e, t, r, i) {
		...
		if (a.isSymbolicLink()) return w(e, t, r, i);
	...
	function x(e, t, r, i) {
		return n.mkdirSync(r), S(t, r, i), _(r, e);
	}
	function S(e, t, r) {
		n.readdirSync(e).forEach((n) => C(n, e, t, r));
	}
	function C(e, t, n, i) {
	...
	var n = x().fromCallback;
	t.exports = {
		copy: n(N()),
		copySync: P()
	};
})), I = /* @__PURE__ */ _(((e, t) => {
	var n = T(), r = b("path"), i = b("assert"), a = process.platform === "win32";
	function o(e) {
		[
			"unlink",
			"chmod",
	...
	var n = x().fromPromise, r = E(), i = b("path"), a = k(), o = ee(), s = n(async function(e) {
		let t;
		try {
			t = await r.readdir(e);
		} catch {
	...
	var n = x().fromCallback, r = b("path"), i = T(), a = k();
	function o(e, t) {
		function n() {
			i.writeFile(e, "", (e) => {
				if (e) return t(e);
	...
	var n = x().fromCallback, r = b("path"), i = T(), a = k(), o = A().pathExists, { areIdentical: s } = M();
	function c(e, t, n) {
		function c(e, t) {
			i.link(e, t, (e) => {
				if (e) return n(e);
	...
	var n = b("path"), r = T(), i = A().pathExists;
	function a(e, t, a) {
	...
	var n = x().fromCallback, r = b("path"), i = E(), a = k(), o = a.mkdirs, s = a.mkdirsSync, c = R(), l = c.symlinkPaths, u = c.symlinkPathsSync, d = z(), f = d.symlinkType, p = d.symlinkTypeSync, m = A().pathExists, { areIdentical: h } = M();
	function g(e, t, n, r) {
	...
	var { createFile: n, createFileSync: r } = te(), { createLink: i, createLinkSync: a } = ne(), { createSymlink: o, createSymlinkSync: s } = B();
	t.exports = {
		createFile: n,
		createFileSync: r,
		ensureFile: n,
	...
	var r = x(), { stringify: i, stripBom: a } = ie();
	...
	var n = x().fromCallback, r = T(), i = b("path"), a = k(), o = A().pathExists;
	function s(e, t, n, s) {
	...
	var { stringify: n } = ie(), { outputFile: r } = H();
	async function i(e, t, i = {}) {
		await r(e, n(t, i), i);
	}
	t.exports = i;
})), se = /* @__PURE__ */ _(((e, t) => {
	var { stringify: n } = ie(), { outputFileSync: r } = H();
	function i(e, t, i) {
		r(e, n(t, i), i);
	}
	t.exports = i;
})), ce = /* @__PURE__ */ _(((e, t) => {
	var n = x().fromPromise, r = ae();
	r.outputJson = n(oe()), r.outputJsonSync = se(), r.outputJSON = r.outputJson, r.outputJSONSync = r.outputJsonSync, r.writeJSON = r.writeJson, r.writeJSONSync = r.writeJsonSync, r.readJSON = r.readJson, r.readJSONSync = r.readJsonSync, t.exports = r;
})), le = /* @__PURE__ */ _(((e, t) => {
	var n = T(), r = b("path"), i = F().copy, a = ee().remove, o = k().mkdirp, s = A().pathExists, c = M();
	function l(e, t, n, i) {
	...
	var n = T(), r = b("path"), i = F().copySync, a = ee().removeSync, o = k().mkdirpSync, s = M();
	function c(e, t, n) {
		n ||= {};
	...
	var n = b("os"), r = b("tty"), i = ge(), { env: a } = process, o;
	...
	t.exports = typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? he() : _e();
})), ye = /* @__PURE__ */ _(((e) => {
	...
	var t = b("crypto"), n = ve(), r = b("fs"), i = b("stream"), a = b("url"), o = fe(), s = W(), c = ye(), l = (0, n.default)("electron-builder"), u = (e) => e.toLowerCase().replace(/[-_]/g, ""), d = /* @__PURE__ */ new Set([
		"authorization",
		"proxyauthorization",
		"privatetoken",
		"xapikey",
	...
	e.HttpExecutor = class e {
		...
		handleResponse(t, n, r, i, a, o, s) {
			if (l.enabled) {
				...
				l(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${j(i)}`);
			}
			if (t.statusCode === 404) {
...
`));
	...
	var t = b("crypto"), n = W(), r = "options.name must be either a string or a Buffer", i = (0, t.randomBytes)(16);
	i[0] |= 1;
	var a = {}, o = [];
	for (let e = 0; e < 256; e++) {
	...
	(function(e) {
		...
		function re(e) {
			...
			return e.ENTITIES[t] ? e.ENTITIES[t] : e.ENTITIES[n] ? e.ENTITIES[n] : (t = n, t.charAt(0) === "#" && (t.charAt(1) === "x" ? (t = t.slice(2), r = parseInt(t, 16), i = r.toString(16)) : (t = t.slice(1), r = parseInt(t, 10), i = r.toString(10))), t = t.replace(/^0+/, ""), isNaN(r) || i.toLowerCase() !== t || r < 0 || r > 1114111 || !ie(r) ? (L(e, "Invalid character entity"), "&" + e.entity + ";") : String.fromCodePoint(r));
		}
		function ie(e) {
		...
		function H(t) {
			...
			for (var i = 0, a = ""; a = ae(t, i++), n.c = a, a;) switch (n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++), n.state) {
				case E.BEGIN:
				...
				case E.TEXT:
					if (n.sawRoot && !n.closedRoot) {
						for (var o = i - 1; a && a !== "<" && a !== "&";) a = ae(t, i++), a && n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++);
				...
				case E.COMMENT_ENDED:
					a === ">" ? n.state = n.doctype && n.doctype !== !0 ? E.DOCTYPE_DTD : E.TEXT : (L(n, "Malformed comment"), n.comment += "--" + a, n.state = E.COMMENT);
					continue;
				case E.CDATA:
					for (var o = i - 1; a && a !== "]";) a = ae(t, i++), a && n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++);
				...
				case E.PROC_INST_ENDING:
					...
					continue;
				case E.OPEN_TAG:
					w(_, a) ? n.tagName += a : (te(n), a === ">" ? z(n) : a === "/" ? n.state = E.OPEN_TAG_SLASH : (x(a) || L(n, "Invalid character in tag name"), n.state = E.ATTRIB));
					continue;
				...
				case E.ATTRIB:
					if (x(a)) continue;
					a === ">" ? z(n) : a === "/" ? n.state = E.OPEN_TAG_SLASH : w(g, a) ? (n.attribName = a, n.attribValue = "", n.state = E.ATTRIB_NAME) : L(n, "Invalid attribute name");
					continue;
				case E.ATTRIB_NAME:
					a === "=" ? n.state = E.ATTRIB_VALUE : a === ">" ? (L(n, "Attribute without value"), n.attribValue = n.attribName, R(n), z(n)) : x(a) ? n.state = E.ATTRIB_NAME_SAW_WHITE : w(_, a) ? n.attribName += a : L(n, "Invalid attribute name");
					continue;
				case E.ATTRIB_NAME_SAW_WHITE:
					if (a === "=") n.state = E.ATTRIB_VALUE;
						...
						name: n.attribName,
						value: ""
					}), n.attribName = "", a === ">" ? z(n) : w(g, a) ? (n.attribName = a, n.state = E.ATTRIB_NAME) : (L(n, "Invalid attribute name"), n.state = E.ATTRIB);
					continue;
				case E.ATTRIB_VALUE:
					if (x(a)) continue;
				...
				case E.ATTRIB_VALUE_CLOSED:
					x(a) ? n.state = E.ATTRIB : a === ">" ? z(n) : a === "/" ? n.state = E.OPEN_TAG_SLASH : w(g, a) ? (L(n, "No whitespace between attributes"), n.attribName = a, n.attribValue = "", n.state = E.ATTRIB_NAME) : L(n, "Invalid attribute name");
					continue;
				case E.ATTRIB_VALUE_UNQUOTED:
					...
					continue;
				case E.CLOSE_TAG:
					if (n.tagName) a === ">" ? B(n) : w(_, a) ? n.tagName += a : n.script ? (n.script += "</" + n.tagName + a, n.tagName = "", n.state = E.SCRIPT) : (x(a) || L(n, "Invalid tagname in closing tag"), n.state = E.CLOSE_TAG_SAW_WHITE);
					else {
						if (x(a)) continue;
						T(g, a) ? n.script ? (n.script += "</" + a, n.state = E.SCRIPT) : L(n, "Invalid tagname in closing tag.") : n.tagName = a;
					}
					continue;
				...
				case E.ATTRIB_VALUE_ENTITY_U:
					...
					} else w(n.entity.length ? y : v, a) ? n.entity += a : (L(n, "Invalid character in entity name"), n[l] += "&" + n.entity + a, n.entity = "", n.state = c);
					continue;
	...
	var n = ke(), r = q(), i = /* @__PURE__ */ RegExp("^(?:[-+]?(?:[0-9]+)(?:\\.[0-9]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$"), a = /* @__PURE__ */ RegExp("^(?:[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");
	function o(e) {
	...
	var n = ke(), r = Ae(), i = je(), a = Ye(), o = Object.prototype.hasOwnProperty, s = 1, c = 2, l = 3, u = 4, d = 1, f = 2, p = 3, m = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, h = /[\x85\u2028\u2029]/, g = /[,\[\]{}]/, _ = /^(?:!|!!|![0-9A-Za-z-]+!)$/, v = /^(?:!|[^,\[\]{}])(?:%[0-9a-f]{2}|[0-9a-z\-#;/?:@&=+$,_.!~*'()\[\]])*$/i;
	function y(e) {
	...
	function ie(e, t, r, i) {
		n.isObject(r) || P(e, "cannot merge mappings; the provided source object is unacceptable"), re(e);
		let a = Object.keys(r);
		for (let n = 0, s = a.length; n < s; n += 1) {
			let s = a[n];
			re(e), o.call(t, s) || (k(t, s, r[s]), i[s] = !0);
		}
	}
	function V(e, t, n, r, i, a, s, c, l) {
		if (Array.isArray(i)) {
		...
		if (typeof i == "object" && y(i) === "[object Object]" && (i = "[object Object]"), i = String(i), t === null && (t = {}), r === "tag:yaml.org,2002:merge") {
			if (Array.isArray(a)) {
				...
				for (let r = 0, i = a.length; r < i; r += 1) ie(e, t, a[r], n);
			} else ie(e, t, a, n);
	...
	function H(e, t, n) {
		...
		for (; i !== 0;) {
			...
			while (i !== 10 && i !== 13 && i !== 0);
			if (b(i)) for (ae(e), i = e.input.charCodeAt(e.position), r++, e.lineIndent = 0; i === 32;) e.lineIndent++, i = e.input.charCodeAt(++e.position);
			else break;
		}
	...
	function ce(e, t, n) {
		...
		for (e.kind = "scalar", e.result = "", r = i = e.position, a = !1; d !== 0;) {
			if (d === 58) {
				...
				if (o = e.line, s = e.lineStart, c = e.lineIndent, H(e, !1, -1), e.lineIndent >= t) {
			...
			a &&= (B(e, r, i, !1), se(e, e.line - o), r = i = e.position, !1), x(d) || (i = e.position + 1), d = e.input.charCodeAt(++e.position);
		}
	...
	function le(e, t) {
		...
		} else b(i) ? (B(e, n, r, !0), se(e, H(e, !1, t)), n = r = e.position) : e.position === e.lineStart && oe(e) ? P(e, "unexpected end of the document within a single quoted scalar") : (e.position++, x(i) || (r = e.position));
	...
	function ue(e, t) {
		...
		for (e.kind = "scalar", e.result = "", e.position++, n = r = e.position; (a = e.input.charCodeAt(e.position)) !== 0;) if (a === 34) return B(e, n, e.position, !0), e.position++, !0;
			...
			if (B(e, n, e.position, !0), a = e.input.charCodeAt(++e.position), b(a)) H(e, !1, t);
			...
			n = r = e.position;
		} else b(a) ? (B(e, n, r, !0), se(e, H(e, !1, t)), n = r = e.position) : e.position === e.lineStart && oe(e) ? P(e, "unexpected end of the document within a double quoted scalar") : (e.position++, x(a) || (r = e.position));
	...
	function de(e, t) {
		...
		for (e.anchor !== null && I(e, e.anchor, c), v = e.input.charCodeAt(++e.position); v !== 0;) {
			...
			n ? v === 44 && P(e, "expected the node content, but found ','") : P(e, "missed comma between flow collection entries"), g = h = _ = null, d = f = !1, v === 63 && S(e.input.charCodeAt(e.position + 1)) && (d = f = !0, e.position++, H(e, !0, t)), r = e.line, i = e.lineStart, a = e.position, G(e, t, s, !1, !0), g = e.tag, h = e.result, H(e, !0, t), v = e.input.charCodeAt(e.position), (f || e.line === r) && v === 58 && (d = !0, v = e.input.charCodeAt(++e.position), H(e, !0, t), G(e, t, s, !1, !0), _ = e.result), p ? V(e, c, m, g, h, _, r, i, a) : d ? c.push(V(e, null, m, g, h, _, r, i, a)) : c.push(h), H(e, !0, t), v = e.input.charCodeAt(e.position), v === 44 ? (n = !0, v = e.input.charCodeAt(++e.position)) : n = !1;
		}
	...
	function U(e, t) {
		...
		for (; m !== 0;) {
			for (ae(e), e.lineIndent = 0, m = e.input.charCodeAt(e.position); (!o || e.lineIndent < s) && m === 32;) e.lineIndent++, m = e.input.charCodeAt(++e.position);
	...
	function fe(e, t) {
		...
		for (; o !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, P(e, "tab characters must not be used in indentation")), o === 45 && S(e.input.charCodeAt(e.position + 1)));) {
			...
			let n = e.line;
			if (G(e, t, l, !1, !0), i.push(e.result), H(e, !0, -1), o = e.input.charCodeAt(e.position), (e.line === n || e.lineIndent > t) && o !== 0) P(e, "bad indentation of a sequence entry");
	...
	function W(e, t, n) {
		...
		for (; v !== 0;) {
			...
			if ((v === 63 || v === 58) && S(y)) v === 63 ? (g && (V(e, d, f, p, m, null, i, a, o), p = m = h = null), _ = !0, g = !0, r = !0) : g ? (g = !1, r = !0) : P(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, v = y;
			else {
				...
				if (e.line === b) {
					...
					if (v === 58) v = e.input.charCodeAt(++e.position), S(v) || P(e, "a whitespace character is expected after the key-value separator within a block mapping"), g && (V(e, d, f, p, m, null, i, a, o), p = m = h = null), _ = !0, g = !1, r = !1, p = e.tag, m = e.result;
			...
			if ((e.line === b || e.lineIndent > t) && (g && (i = e.line, a = e.lineStart, o = e.position), G(e, t, u, !0, r) && (g ? m = e.result : h = e.result), g || (V(e, d, f, p, m, h, i, a, o), p = m = h = null), H(e, !0, -1), v = e.input.charCodeAt(e.position)), (e.line === b || e.lineIndent > t) && v !== 0) P(e, "bad indentation of a mapping entry");
			else if (e.lineIndent < t) break;
		}
		return g && V(e, d, f, p, m, null, i, a, o), _ && (e.tag = s, e.anchor = l, e.kind = "mapping", e.result = d), _;
	}
	function pe(e) {
	...
	function he(e) {
		...
		return o.call(e.anchorMap, r) || P(e, "unidentified alias \"" + r + "\""), e.result = e.anchorMap[r], H(e, !0, -1), !0;
	}
	function ge(e, t, n, r) {
		let i = ne(e);
		return ee(e), R(e, t), e.tag = null, e.anchor = null, e.kind = null, e.result = null, W(e, n, r) && e.kind === "mapping" ? (L(e), !0) : (te(e), R(e, i), !1);
	}
	function G(e, t, n, r, i) {
		...
		if (d &&= p || i, f === 1 || u === n) {
			if (_ = s === n || c === n ? t : t + 1, v = e.position - e.lineStart, f === 1) {
				if (d && (fe(e, v) || W(e, v, _)) || de(e, _)) m = !0;
				else {
					let t = e.input.charCodeAt(e.position);
					h !== null && y && !d && t !== 124 && t !== 62 && ge(e, h, h.position - h.lineStart, _) || a && U(e, _) || le(e, _) || ue(e, _) ? m = !0 : he(e) ? (m = !0, (e.tag !== null || e.anchor !== null) && P(e, "alias node should not have any properties")) : ce(e, _, s === n) && (m = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && I(e, e.anchor, e.result);
				}
			} else f === 0 && (m = d && fe(e, v));
		}
	...
	function _e(e) {
		...
		for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = Object.create(null), e.anchorMap = Object.create(null); (r = e.input.charCodeAt(e.position)) !== 0 && (H(e, !0, -1), r = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || r !== 37));) {
			...
			r !== 0 && ae(e), o.call(z, i) ? z[i](e, i, a) : F(e, "unknown document directive \"" + i + "\"");
		}
		if (H(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, H(e, !0, -1)) : n && P(e, "directives end mark is expected"), G(e, e.lineIndent - 1, u, !1, !0), H(e, !0, -1), e.checkLineBreaks && h.test(e.input.slice(t, e.position)) && F(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && oe(e)) {
	...
	var n = ke(), r = Ae(), i = Ye(), a = Object.prototype.toString, o = Object.prototype.hasOwnProperty, s = 65279, c = 9, l = 10, u = 13, d = 32, f = 33, p = 34, m = 35, h = 37, g = 38, _ = 39, v = 42, y = 44, b = 45, x = 58, S = 61, C = 62, w = 63, T = 64, E = 91, D = 93, O = 96, k = 123, A = 124, j = 125, M = {};
	...
	function ie(e) {
		return re(e) && e !== s && e !== u && e !== l;
	}
	function V(e, t, n) {
		let r = ie(e), i = r && !B(e);
		return (n ? r : r && e !== y && e !== E && e !== D && e !== k && e !== j) && e !== m && !(t === x && !i) || ie(t) && !B(t) && e === m || t === x && i;
	}
	function ae(e) {
		return re(e) && e !== s && !B(e) && e !== b && e !== w && e !== x && e !== y && e !== E && e !== D && e !== k && e !== j && e !== m && e !== g && e !== v && e !== f && e !== A && e !== S && e !== C && e !== _ && e !== p && e !== h && e !== T && e !== O;
	}
	function H(e) {
		return !B(e) && e !== x;
	}
	...
	function fe(e, t, n, r, i, a, o, s) {
		let c, u = 0, d = null, f = !1, p = !1, m = r !== -1, h = -1, g = ae(oe(e, 0)) && H(oe(e, e.length - 1));
		if (t || o) for (c = 0; c < e.length; u >= 65536 ? c += 2 : c++) {
			if (u = oe(e, c), !re(u)) return U;
			g &&= V(u, d, s), d = u;
		}
		else {
			for (c = 0; c < e.length; u >= 65536 ? c += 2 : c++) {
				if (u = oe(e, c), u === l) f = !0, m && (p ||= c - h - 1 > r && e[h + 1] !== " ", h = c);
				else if (!re(u)) return U;
				g &&= V(u, d, s), d = u;
			}
			p ||= m && c - h - 1 > r && e[h + 1] !== " ";
		}
		return !f && !p ? g && !o && !i(e) ? ce : a === L ? U : le : n > 9 && se(e) ? U : o ? a === L ? U : le : p ? de : ue;
	}
	function W(e, t, n, i, a) {
		e.dump = function() {
			...
			switch (fe(t, c, e.indent, s, l, e.quotingType, e.forceQuotes && !i, a)) {
				...
				case ue: return "|" + pe(t, e.indent) + me(ne(t, o));
				case de: return ">" + pe(t, e.indent) + me(ne(he(t, s), o));
				case U: return "\"" + G(t, s) + "\"";
	...
	function G(e) {
		...
		for (let r = 0; r < e.length; n >= 65536 ? r += 2 : r++) {
			n = oe(e, r);
			let i = M[n];
			!i && re(n) ? (t += e[r], n >= 65536 && (t += e[r + 1])) : t += i || I(n);
		}
		return t;
	}
	function _e(e, t, n) {
	...
	function ve(e, t, n, r) {
		...
		for (let a = 0, o = n.length; a < o; a += 1) {
			let o = n[a];
			e.replacer && (o = e.replacer.call(n, String(a), o)), (Se(e, t + 1, o, !0, !0, !1, !0) || o === void 0 && Se(e, t + 1, null, !0, !0, !1, !0)) && ((!r || i !== "") && (i += R(e, t)), e.dump && l === e.dump.charCodeAt(0) ? i += "-" : i += "- ", i += e.dump);
		}
		e.tag = a, e.dump = i || "[]";
	}
	function ye(e, t, n) {
	...
	function be(e, t, n, i) {
		...
		for (let r = 0, o = s.length; r < o; r += 1) {
			...
			d && (e.dump && l === e.dump.charCodeAt(0) ? o += "?" : o += "? "), o += e.dump, d && (o += R(e, t)), Se(e, t + 1, u, !0, d) && (e.dump && l === e.dump.charCodeAt(0) ? o += ":" : o += ": ", o += e.dump, a += o);
		}
		e.tag = o, e.dump = a || "{}";
	}
	function xe(e, t, n) {
	...
	t.exports.Type = q(), t.exports.Schema = Me(), t.exports.FAILSAFE_SCHEMA = Ie(), t.exports.JSON_SCHEMA = Ve(), t.exports.CORE_SCHEMA = He(), t.exports.DEFAULT_SCHEMA = Ye(), t.exports.load = n.load, t.exports.loadAll = n.loadAll, t.exports.dump = r.dump, t.exports.YAMLException = Ae(), t.exports.types = {
		binary: Ge(),
		float: Be(),
		map: Fe(),
		null: Le(),
	...
	var { MAX_SAFE_COMPONENT_LENGTH: n, MAX_SAFE_BUILD_LENGTH: r, MAX_LENGTH: i } = et(), a = tt();
	e = t.exports = {};
	...
	var n = tt(), { MAX_LENGTH: r, MAX_SAFE_INTEGER: i } = et(), { safeRe: a, t: o } = J(), s = nt(), { compareIdentifiers: c } = rt();
	t.exports = class e {
		constructor(t, c) {
	...
	var n = bt(), r = xt(), i = vt(), a = St(), o = yt(), s = Ct();
	t.exports = (e, t, c, l) => {
		switch (t) {
	...
	var r = new (Et())(), i = nt(), a = Dt(), o = tt(), s = Y(), { safeRe: c, t: l, comparatorTrimReplace: u, tildeTrimReplace: d, caretTrimReplace: f } = J(), { FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: m } = et(), h = (e) => e.value === "<0.0.0-0", g = (e) => e.value === "", _ = (e, t) => {
	...
	var r = nt(), { safeRe: i, t: a } = J(), o = wt(), s = tt(), c = Y(), l = Z();
})), Ot = /* @__PURE__ */ _(((e, t) => {
	var n = Z();
	t.exports = (e, t, r) => {
		try {
	...
	var n = Y(), r = Dt(), { ANY: i } = r, a = Z(), o = Ot(), s = vt(), c = yt(), l = Ct(), u = St();
	t.exports = (e, t, d, f) => {
	...
	var n = Z(), r = Dt(), { ANY: i } = r, a = Ot(), o = X(), s = (e, t, r = {}) => {
		if (e === t) return !0;
	...
	var N = typeof global == "object" && global && global.Object === Object && global, P = typeof self == "object" && self && self.Object === Object && self, F = N || P || Function("return this")(), I = typeof e == "object" && e && !e.nodeType && e, ee = I && typeof t == "object" && t && !t.nodeType && t, L = ee && ee.exports === I, te = L && N.process, ne = function() {
		try {
			return te && te.binding && te.binding("util");
		} catch {}
	}(), R = ne && ne.isTypedArray;
	function z(e, t) {
	...
	var le = Array.prototype, ue = Function.prototype, de = Object.prototype, U = F["__core-js_shared__"], fe = ue.toString, W = de.hasOwnProperty, pe = function() {
		var e = /[^.]+$/.exec(U && U.keys && U.keys.IE_PROTO || "");
		return e ? "Symbol(src)_1." + e : "";
	}(), me = de.toString, he = RegExp("^" + fe.call(W).replace(k, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), ge = L ? F.Buffer : void 0, G = F.Symbol, _e = F.Uint8Array, ve = de.propertyIsEnumerable, ye = le.splice, be = G ? G.toStringTag : void 0, xe = Object.getOwnPropertySymbols, Se = ge ? ge.isBuffer : void 0, Ce = se(Object.keys, Object), we = bt(F, "DataView"), Te = bt(F, "Map"), Ee = bt(F, "Promise"), De = bt(F, "Set"), Oe = bt(F, "WeakMap"), K = bt(Object, "create"), ke = Ot(we), Ae = Ot(Te), je = Ot(Ee), q = Ot(De), Me = Ot(Oe), Ne = G ? G.prototype : void 0, Pe = Ne ? Ne.valueOf : void 0;
	function Fe(e) {
	...
	function Be(e, t) {
		var r = this.__data__;
		return this.size += +!this.has(e), r[e] = K && t === void 0 ? n : t, this;
	}
	Fe.prototype.clear = Ie, Fe.prototype.delete = Le, Fe.prototype.get = Re, Fe.prototype.has = ze, Fe.prototype.set = Be;
	function Ve(e) {
		var t = -1, n = e == null ? 0 : e.length;
		for (this.clear(); ++t < n;) {
			var r = e[t];
	...
	Ve.prototype.clear = He, Ve.prototype.delete = Ue, Ve.prototype.get = We, Ve.prototype.has = Ge, Ve.prototype.set = Ke;
	function qe(e) {
		var t = -1, n = e == null ? 0 : e.length;
		for (this.clear(); ++t < n;) {
			var r = e[t];
	...
	J.prototype.clear = nt, J.prototype.delete = rt, J.prototype.get = Y, J.prototype.has = it, J.prototype.set = at;
	function ot(e, t) {
		var n = jt(e), r = !n && At(e), i = !n && !r && Nt(e), a = !n && !r && !i && zt(e), o = n || r || i || a, s = o ? ie(e.length, String) : [], c = s.length;
		for (var l in e) (t || W.call(e, l)) && !(o && (l == "length" || i && (l == "offset" || l == "parent") || a && (l == "buffer" || l == "byteLength" || l == "byteOffset") || wt(l, c))) && s.push(l);
		return s;
	}
	function st(e, t) {
	...
	function ct(e, t, n) {
		var r = t(e);
		return jt(e) ? r : B(r, n(e));
	}
	function lt(e) {
		return e == null ? e === void 0 ? "[object Undefined]" : "[object Null]" : be && be in Object(e) ? xt(e) : Dt(e);
	}
	function ut(e) {
		return Rt(e) && lt(e) == i;
	}
	function dt(e, t, n, r, i) {
		return e === t ? !0 : e == null || t == null || !Rt(e) && !Rt(t) ? e !== e && t !== t : ft(e, t, n, r, dt, i);
	}
	function ft(e, t, n, r, o, s) {
		var c = jt(e), l = jt(t), u = c ? a : Ct(e), d = l ? a : Ct(t);
		u = u == i ? f : u, d = d == i ? f : d;
		...
		if (h && !p) return s ||= new J(), c || zt(e) ? ht(e, t, n, r, o, s) : gt(e, t, u, n, r, o, s);
		if (!(n & 1)) {
			var g = p && W.call(e, "__wrapped__"), _ = m && W.call(t, "__wrapped__");
			if (g || _) {
				var v = g ? e.value() : e, y = _ ? t.value() : t;
				return s ||= new J(), o(v, y, n, r, s);
			}
		}
		return h ? (s ||= new J(), _t(e, t, n, r, o, s)) : !1;
	}
	function X(e) {
		return !Lt(e) || Et(e) ? !1 : (Ft(e) ? he : A).test(Ot(e));
	}
	function pt(e) {
		return Rt(e) && It(e.length) && !!M[lt(e)];
	}
	function mt(e) {
		if (!Z(e)) return Ce(e);
		var t = [];
		...
		for (a.set(e, t), a.set(t, e); ++u < s;) {
			...
			if (f) {
				if (!re(t, function(e, t) {
					if (!ae(f, t) && (p === e || i(p, e, n, r, a))) return f.push(t);
				})) {
					d = !1;
					break;
				}
	...
	function gt(e, t, n, r, i, a, l) {
		switch (n) {
			...
			case h:
				var p = r & 1;
				if (f ||= ce, e.size != t.size && !p) return !1;
				var _ = l.get(e);
				if (_) return _ == t;
				r |= 2, l.set(e, t);
				var b = ht(f(e), f(t), r, i, a, l);
				return l.delete(e), b;
			case "[object Symbol]": if (Pe) return Pe.call(e) == Pe.call(t);
		}
		return !1;
	}
	function _t(e, t, n, r, i, a) {
		var o = n & 1, s = vt(e), c = s.length;
		if (c != vt(t).length && !o) return !1;
		for (var l = c; l--;) {
			var u = s[l];
	...
	var St = xe ? function(e) {
		return e == null ? [] : (e = Object(e), z(xe(e), function(t) {
			return ve.call(e, t);
		}));
	} : Vt, Ct = lt;
	(we && Ct(new we(/* @__PURE__ */ new ArrayBuffer(1))) != y || Te && Ct(new Te()) != u || Ee && Ct(Ee.resolve()) != p || De && Ct(new De()) != h || Oe && Ct(new Oe()) != _) && (Ct = function(e) {
		var t = lt(e), n = t == f ? e.constructor : void 0, r = n ? Ot(n) : "";
		if (r) switch (r) {
			case ke: return y;
			case Ae: return u;
			case je: return p;
	...
	var At = ut(function() {
		...
		return Rt(e) && W.call(e, "callee") && !ve.call(e, "callee");
	}, jt = Array.isArray;
	function Mt(e) {
		return e != null && It(e.length) && !Ft(e);
	}
	var Nt = Se || Ht;
	function Pt(e, t) {
		return dt(e, t);
	...
	var t = b("crypto"), n = b("fs"), r = Vt(), i = U(), a = b("path");
	...
	function n() {
		return b("electron").session.fromPartition(e.NET_SESSION_NAME, { cache: !1 });
	}
	...
	var t = K(), n = Qe(), r = b("url"), i = Kt(), a = qt();
	e.Provider = class {
		constructor(e) {
	...
	var t = K(), n = Bt(), r = b("url"), i = Kt(), a = Q(), o = /\/tag\/(v?[^/]+)$/, s = class extends a.Provider {
		constructor(e, n, r) {
			super({
				...r,
				isUseMultipleRangeRequest: !1
	...
	var t = K(), n = Qe(), r = b("path"), i = b("url"), a = Kt(), o = Xt(), s = Q();
	...
	var t = K(), n = Yt(), r = Jt(), i = Xt(), a = Zt(), o = Qt(), s = $t();
	function c(e) {
	...
	var t = K(), n = b("fs"), r = b("stream"), i = tn(), a = Buffer.from("\r\n\r\n"), o;
	(function(e) {
	...
	var t = K(), n = U(), r = b("fs"), i = nn(), a = b("url"), o = tn(), s = rn(), c = an();
	...
	var t = K(), n = b("crypto"), r = b("os"), i = b("events"), a = U(), o = Qe(), s = $e(), c = b("path"), l = Bt(), u = Ht(), d = Wt(), f = Gt(), p = Jt(), m = en(), h = b("zlib"), g = sn(), _ = cn();
	e.AppUpdater = class e extends i.EventEmitter {
		...
		checkForUpdatesAndNotify(t) {
			return this.checkForUpdates().then((n) => n?.downloadPromise ? (n.downloadPromise.then(() => {
				...
				new (b("electron")).Notification(r).show();
	...
	var t = b("child_process"), n = b("path"), r = ln();
	e.BaseUpdater = class extends r.AppUpdater {
		...
		quitAndInstall(e = !1, t = !1) {
			this._logger.info("Install on explicit quitAndInstall"), this.install(e, e ? t : this.autoRunAppAfterInstall) ? setImmediate(() => {
				b("electron").autoUpdater.emit("before-quit-for-update"), this.app.quit();
	...
	var t = K(), n = b("child_process"), r = U(), i = b("fs"), a = b("path"), o = un(), s = dn(), c = Q(), l = cn();
	...
	var t = K(), n = U(), r = b("fs"), i = b("path"), a = b("http"), o = ln(), s = Q(), c = b("child_process"), l = b("crypto");
	e.MacUpdater = class e extends o.AppUpdater {
		constructor(e, t) {
			super(e, t), this.nativeUpdater = b("electron").autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (e) => {
	...
	var t = K(), n = b("child_process"), r = b("os"), i = b("path");
	function a(e, t) {
		return [
	...
	var t = K(), n = b("path"), r = un(), i = dn(), a = cn(), o = Q(), s = U(), c = vn(), l = b("url");
	e.NsisUpdater = class extends r.BaseUpdater {
		...
		doInstall(e) {
			...
			return e.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), a(), !0) : (this.spawnLog(t, r).catch((e) => {
				let n = e.code;
				this._logger.info(`Cannot run installer: error code: ${n}, error message: "${e.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), n === "UNKNOWN" || n === "EACCES" ? a() : n === "ENOENT" ? b("electron").shell.openPath(t).catch((e) => this.dispatchError(e)) : this.dispatchError(e);
			}), !0);
		}
	...
	function h() {
		...
		else if (process.platform === "darwin") m = new (_n()).MacUpdater();
		else {
			m = new (fn()).AppImageUpdater();
			try {
	...
	t.exports = class {
		...
		showDialog = !1;
		preventDefault = !0;
		constructor({ logFn: e = null } = {}) {
			this.handleError = this.handleError.bind(this), this.handleRejection = this.handleRejection.bind(this), this.startCatching = this.startCatching.bind(this), this.logFn = e;
		}
		handle(e, { logFn: t = this.logFn, errorName: r = "", onError: i = this.onError, showDialog: a = this.showDialog } = {}) {
			try {
				i?.({
					error: e,
					errorName: r,
		...
		setOptions({ logFn: e, onError: t, preventDefault: n, showDialog: r }) {
			typeof e == "function" && (this.logFn = e), typeof t == "function" && (this.onError = t), typeof n == "boolean" && (this.preventDefault = n), typeof r == "boolean" && (this.showDialog = r);
		}
		startCatching({ onError: e, showDialog: t } = {}) {
			this.isActive || (this.isActive = !0, this.setOptions({
				...
				this.preventDefault && e.preventDefault?.(), this.handleError(e.error || e);
			}), window.addEventListener("unhandledrejection", (e) => {
				this.preventDefault && e.preventDefault?.(), this.handleRejection(e.reason || e);
			}));
		}
		handleError(e) {
	...
	function a({ data: e = [], logger: t = {}, message: n = {}, transport: r = {} }) {
		if (typeof r.format == "function") return r.format({
			data: e,
			level: n?.level || "info",
			logger: t,
			message: n,
		...
		if (typeof r.format != "string") return e;
		e.unshift(r.format), typeof e[1] == "string" && e[1].match(/%[1cdfiOos]/) && (e = [`${e[0]}${e[1]}`, ...e.slice(2)]);
		let i = n.date || /* @__PURE__ */ new Date();
		return e[0] = e[0].replace(/\{(\w+)}/g, (e, r) => {
			switch (r) {
				case "level": return n.level;
				case "logId": return n.logId;
				case "scope": {
					let e = n.scope || t.scope?.defaultLabel;
					return e ? ` (${e})` : "";
				}
				case "text": return "";
				case "y": return i.getFullYear().toString(10);
				case "m": return (i.getMonth() + 1).toString(10).padStart(2, "0");
				case "d": return i.getDate().toString(10).padStart(2, "0");
				case "h": return i.getHours().toString(10).padStart(2, "0");
				case "i": return i.getMinutes().toString(10).padStart(2, "0");
				case "s": return i.getSeconds().toString(10).padStart(2, "0");
				case "ms": return i.getMilliseconds().toString(10).padStart(3, "0");
				case "iso": return i.toISOString();
				default: return n.variables?.[r] || e;
			}
		}).trim(), e;
	}
})), On = /* @__PURE__ */ _(((e, t) => {
	...
	function o({ data: e, depth: t, seen: n = /* @__PURE__ */ new WeakSet(), transport: i = {} } = {}) {
		let s = t || i.depth || 5;
		return n.has(e) ? "[Circular]" : s < 1 ? a(e) ? e : Array.isArray(e) ? "[Array]" : `[${typeof e}]` : ["function", "symbol"].includes(typeof e) ? e.toString() : a(e) ? e : r.has(e.constructor) ? `[${e.constructor.name}]` : Array.isArray(e) ? e.map((e) => o({
			data: e,
			depth: s - 1,
			seen: n
		})) : e instanceof Date ? e.toISOString() : e instanceof Error ? e.stack : e instanceof Map ? new Map(Array.from(e).map(([e, t]) => [o({
			data: e,
			depth: s - 1,
			seen: n
		}), o({
			...
			depth: s - 1,
			seen: n
		})])) : e instanceof Set ? new Set(Array.from(e).map((e) => o({
			data: e,
			depth: s - 1,
			seen: n
		}))) : (n.add(e), Object.fromEntries(Object.entries(e).map(([e, t]) => [e, o({
			data: t,
			depth: s - 1,
			seen: n
		})])));
	...
	var n = wn(), r = Tn(), i = Dn(), a = On();
	typeof process == "object" && process.type === "browser" && console.warn("electron-log/renderer is loaded in the main process. It could cause unexpected behaviour."), t.exports = o(), t.exports.Logger = n, t.exports.default = t.exports;
	function o() {
		let e = new n({
			allowUnknownLevel: !0,
			errorHandler: new r(),
		...
		return e.errorHandler.setOptions({ logFn({ error: t, errorName: n, showDialog: r }) {
			e.transports.console({
			...
			let { cmd: t, logId: r, ...i } = e.data || {}, a = n.getInstance({ logId: r });
			t === "message" && a.processMessage(i, { transports: ["console"] });
		}), new Proxy(e, { get(t, n) {
			return t[n] === void 0 ? (...t) => e.logData(t, { level: n }) : t[n];
		} });
	}
})), An = /* @__PURE__ */ _(((e, t) => {
	var n = b("fs"), r = b("path");
	...
	function c() {
		try {
			return b.main?.filename;
		} catch {
			return;
		}
	}
})), jn = /* @__PURE__ */ _(((e, t) => {
	var n = b("child_process"), r = b("os"), i = b("path"), a = An();
	t.exports = class {
		appName = void 0;
	...
	var n = b("fs"), r = b("os"), i = b("path"), a = xn(), o = !1, s = !1;
	...
	var { concatFirstStringElements: n, format: r } = In(), { maxDepth: i, toJSON: a } = Ln(), { applyAnsiStyles: o, removeStyles: s } = Rn(), { transform: c } = En(), l = {
		error: console.error,
		warn: console.warn,
		info: console.info,
		verbose: console.info,
	...
	t.exports = class extends n {
		...
		clear() {
			try {
				...
				return e.code === "ENOENT" || (this.emit("error", e, this), !1);
			}
		}
		crop(e) {
			try {
	...
	var n = b("events"), r = b("fs"), i = b("path"), a = Bn(), o = Vn();
	t.exports = class extends n {
		store = {};
		constructor() {
	...
	var n = b("fs"), r = b("os"), i = b("path"), a = Hn(), { transform: o } = En(), { removeStyles: s } = Rn(), { format: c, concatFirstStringElements: l } = In(), { toString: u } = Ln();
	t.exports = f;
	var d = new a();
	...
	var { maxDepth: n, toJSON: r } = Ln(), { transform: i } = En();
	t.exports = a;
	...
	var n = b("http"), r = b("https"), { transform: i } = En(), { removeStyles: a } = Rn(), { toJSON: o, maxDepth: s } = Ln();
	t.exports = c;
	function c(e) {
		return Object.assign(t, {
	...
	var n = wn(), r = Pn(), i = Fn(), a = zn(), o = Un(), s = Wn(), c = Gn();
	t.exports = l;
	...
	var n = b("electron"), r = Mn(), { initialize: i } = Nn(), a = Kn(), o = new r({ electron: n }), s = a({
	...
	var n = jn();
	t.exports = Kn()({ dependencies: { externalApi: new n() } });
})), Yn = /* @__PURE__ */ _(((e, t) => {
	var n = typeof process > "u" || process.type === "renderer" || process.type === "worker", r = typeof process == "object" && process.type === "browser";
	n ? (xn(), t.exports = kn()) : t.exports = r ? qn() : Jn();
})), Xn = bn(), Zn = /* @__PURE__ */ y(Yn(), 1), Qn = e(import.meta.url), $n = u.dirname(l(import.meta.url));
process.env.APP_ROOT = u.join($n, "..");
var er = process.env.VITE_DEV_SERVER_URL, tr = u.join(process.env.APP_ROOT, "dist-electron"), nr = u.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = er ? u.join(process.env.APP_ROOT, "public") : nr;
var $ = null, rr = null, ir = !1;
Qn("./monitor.cjs"), s.on("check-for-updates", () => {
	Xn.autoUpdater.checkForUpdatesAndNotify();
}), s.on("install-update", () => {
	Xn.autoUpdater.quitAndInstall();
}), s.handle("get-app-version", () => a.getVersion()), s.handle("set-always-on-top", (e, t) => ($?.setAlwaysOnTop(t), t)), s.handle("set-auto-launch", (e, t) => (a.setLoginItemSettings({
	openAtLogin: t,
	path: a.getPath("exe")
}), t)), s.handle("get-auto-launch", () => a.getLoginItemSettings().openAtLogin), s.on("show-notification", (e, { title: t, body: n }) => {
	new r({
		title: t,
		body: n,
		icon: u.join(process.env.VITE_PUBLIC || "", "logo.png")
	}).show();
}), s.handle("get-system-idle-time", () => c.getSystemIdleTime());
function ar() {
	$ = new t({
		width: 1200,
		height: 800,
		icon: u.join(process.env.VITE_PUBLIC || "", "logo.png"),
		webPreferences: {
			preload: u.join($n, "preload.cjs"),
			nodeIntegration: !1,
			contextIsolation: !0
		},
		autoHideMenuBar: !0
	}), Zn.default.transports.file.level = "info", Xn.autoUpdater.logger = Zn.default, Xn.autoUpdater.on("checking-for-update", () => {
		$?.webContents.send("updater-message", { status: "checking" });
	}), Xn.autoUpdater.on("update-available", (e) => {
		$?.webContents.send("updater-message", {
			status: "update-available",
			info: e
		});
	}), Xn.autoUpdater.on("update-not-available", (e) => {
		$?.webContents.send("updater-message", {
			status: "update-not-available",
			info: e
		});
	}), Xn.autoUpdater.on("error", (e) => {
		$?.webContents.send("updater-message", {
			status: "error",
			error: e.message
		});
	}), Xn.autoUpdater.on("download-progress", (e) => {
		$?.webContents.send("updater-message", {
			status: "downloading",
			percent: e.percent,
	...
	}), Xn.autoUpdater.on("update-downloaded", (e) => {
		$?.webContents.send("updater-message", {
			status: "update-downloaded",
			info: e
		});
	}), $.webContents.on("did-finish-load", () => {
		$?.webContents.send("main-process-message", (/* @__PURE__ */ new Date()).toLocaleString()), er || setTimeout(() => Xn.autoUpdater.checkForUpdatesAndNotify(), 3e3);
	}), er ? $.loadURL(er) : $.loadFile(u.join(nr, "index.html")), $.on("close", (e) => {
		ir || (e.preventDefault(), $?.hide());
	});
}
a.whenReady().then(() => {
	process.platform === "win32" && a.setAppUserModelId("com.workflowpro.app"), ar();
	let e = u.join(process.env.VITE_PUBLIC || "", "logo.png");
	rr = new i(e);
	let t = n.buildFromTemplate([
		{
			label: "Show WorkNexus",
			click: () => {
				$?.show(), $?.focus();
			}
		},
	...
	rr.setToolTip("WorkNexus"), rr.setContextMenu(t), rr.on("click", () => {
		$?.show(), $?.focus();
	}), o.register("CommandOrControl+Shift+W", () => {
		$ && ($.isVisible() && $.isFocused() ? $.hide() : ($.show(), $.focus()));
	});
}), a.on("before-quit", () => {
	ir = !0;
}), a.on("will-quit", () => {
	...
	t.getAllWindows().length === 0 ? ar() : $?.show();
}), a.on("window-all-closed", () => {
	process.platform !== "darwin" && (rr?.destroy(), a.quit());
});
//#endregion
export { tr as MAIN_DIST, nr as RENDERER_DIST, er as VITE_DEV_SERVER_URL };
