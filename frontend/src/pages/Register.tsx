...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 text-slate-900 overflow-hidden relative py-12">
      {/* Abstract Background */}
      ...
      <motion.div 
        ...
        className="w-full max-w-lg p-8 rounded-2xl bg-white shadow-sm backdrop-blur-xl border border-slate-200 z-10 shadow-2xl mx-4"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Register your company on WorkFlow Pro</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                required
                className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all text-slate-900 placeholder-gray-500"
          ...
          <div>
            <label className="block text-sm font-medium text-slate-600 mb-1">Email Address (Admin)</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
