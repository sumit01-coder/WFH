      ...
      {selectedProject && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <motion.div 
            ...
            className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-slate-200 dark:border-slate-800/60"
          >
            {/* Modal Header */}
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white">
              <div className="absolute top-0 right-0 p-4 z-20">
                <button 
                  ...
                  className="bg-white dark:bg-slate-900/20 hover:bg-white/30 backdrop-blur-md text-white p-2 rounded-full transition-all cursor-pointer"
                >
                  <X size={20}/>
                </button>
              </div>
              <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-white dark:bg-slate-900/20 text-white text-xs px-3 py-1 rounded-full font-semibold uppercase tracking-wider backdrop-blur-md">
              ...
              {/* Decorative shapes */}
              <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-white dark:bg-slate-900/10 rounded-full blur-3xl"></div>
